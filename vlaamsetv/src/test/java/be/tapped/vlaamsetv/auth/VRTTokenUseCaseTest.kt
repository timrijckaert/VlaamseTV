...
class VRTTokenUseCaseTest : BehaviorSpec({
    given("A ${VRTTokenUseCase::class.java.simpleName}") {
        ...
        and("refresh call fails") {
            ...
            coEvery { dataStore.token() } returns vrtTokenWrapperArb
                .gen()
        ...
        and("refresh call works") {
            ...
            coEvery { tokenRepo.refreshTokenWrapper(refreshToken) } returns ApiResponse.Success.Authentication
                .Token(newToken)
                .right()
