...
class VRTAZFragment(private val backgroundManager: BackgroundManager) : VerticalGridSupportFragment(),
        ...
        mainFragmentRegistry.registerFragment(
            ...
            object : BrowseSupportFragment.FragmentFactory<Fragment>() {
                override fun createFragment(row: Any?): Fragment {
                    return VRTAZFragment(backgroundManager)
                }
            },
        )
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter = ArrayObjectAdapter(ListRowPresenter()).apply {
            ...
            val liveStreamObjectAdapter = ArrayObjectAdapter(PresenterSelector()).apply {
                LiveStreams.allLiveStreams.forEach {
                    ...
                    add(Item.ImageCard(it.name, imageViewUrl = screenGrab))
                }
            }
