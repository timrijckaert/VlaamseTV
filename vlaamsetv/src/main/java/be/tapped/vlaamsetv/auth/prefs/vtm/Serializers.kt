...
class TokenWrapperSerializer(crypto: Crypto) : EncryptedProtoSerializer<VTMTokenWrapper>(crypto,
                                                                                         VTMTokenWrapper(),
                                                                                         VTMTokenWrapper.ADAPTER)

class VTMCredentialsSerializer(crypto: Crypto) : EncryptedProtoSerializer<VTMGOCredentials>(crypto,
                                                                                            VTMGOCredentials(),
